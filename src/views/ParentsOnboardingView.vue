...
<template>
  <div class="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
    ...
    <div class="p-8 rounded-3xl bg-[var(--surface)] border border-[var(--border-default)] shadow-xl text-center space-y-4">
      <h1 class="text-3xl font-extrabold text-[var(--fg)] font-display">{{ t('slidePages.onboardingTitle') }}</h1>
      <p class="text-sm text-[var(--fg-muted)]">Onboarding taqdimoti yuklanmoqda...</p>
    </div>
  </div>
</template>
